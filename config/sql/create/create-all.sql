...
CREATE TABLE `PAID_MSG_PRODUCT_CONFIG` (
  `ID` bigint(20) NOT NULL,
  `DELETED` bit(1) DEFAULT NULL,
  `ENABLED` bit(1) DEFAULT NULL,
  `CREATION_DATE` datetime DEFAULT NULL,
  ...
  `PRODUCT_ID` bigint(20) NOT NULL,
  PRIMARY KEY (`ID`),
  KEY `FK_83olofwq2cbxabv06gihb1kt4` (`PRODUCT_ID`),
  CONSTRAINT `FK_83olofwq2cbxabv06gihb1kt4` FOREIGN KEY (`PRODUCT_ID`) REFERENCES `PRODUCT` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
