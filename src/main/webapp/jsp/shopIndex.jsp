...
<div class="showContainer show0">
    <img src="/show/resources/img/show/light.png" class="g-light1" alt="">
    <img src="/show/resources/img/show/light.png" class="g-light2" alt="">
    <img src="/show/resources/img/show/light2.png" class="g-light3" alt="">
...
<div class="showContainer show3">
    ...
    <img src="/show/resources/img/show/msf2.png" class="show3-2" alt="">
    ...
    window.onload = function () {
        ...
        function sreenPop(item){
            ...
            if(seconds != 0){
                ...
                if(item.pic){
                    $('.wall-all-left').attr('style','width:60%');
                ...
                if(item.sender.gender == 'MALE'){
                    ...
                    $('.senderCtn').find('.wall-sexy-man').attr("style",'visibility:hidden');
                    $('.senderCtn').find('.wall-sexy-woman').attr("style",'visibility:visible');
                }
